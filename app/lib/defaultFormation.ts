...
export const defaultFormation:FormationFootball[] = [
  ...
  },
  {
    ...
    positions: [
      ...
      //5
      { name: "MI", assigned: false, y:25, x:9 },
      { name: "MCD1", assigned: false, y:35, x:30 },
      { name: "MCO", assigned: false, y:20, x:45 },
      { name: "MCD2", assigned: false, y:35, x:60 },
      { name: "MD", assigned: false, y:25, x:81 },
  ...
  },
  {
    ...
    positions: [
      ...
      //4
      { name: "MI", assigned: false, y:28, x:10 },
      { name: "MCD1", assigned: false, y:36, x:33 },
      { name: "MCD2", assigned: false, y:36, x:56 },
      { name: "MD", assigned: false, y:28, x:79 },
  ...
  },
  {
    ...
    positions: [
      ...
      //3
      { name: "MC1", assigned: false, y:32, x:15 },
      { name: "MC2", assigned: false, y:36, x:45 },
      { name: "MC3", assigned: false, y:32, x:75 },
  ...
  },
  {
    ...
    positions: [
      ...
      //4
      { name: "MI", assigned: false, y:28, x:9 },
      { name: "MC1", assigned: false, y:32, x:27 },
      { name: "MC2", assigned: false, y:32, x:63 },
      { name: "MD", assigned: false, y:28, x:81 },

      //2
      { name: "SD", assigned: false, y:25, x:45 },
  ...
  },
  {
    ...
    positions: [
      ...
      //5
      { name: "MI", assigned: false, y:25, x:9 },
      { name: "MC1", assigned: false, y:30, x:30 },
      { name: "MCO", assigned: false, y:20, x:45 },
      { name: "MC2", assigned: false, y:30, x:60 },
      { name: "MD", assigned: false, y:25, x:81 },
  ...
  },
  {
    ...
    positions: [
      ...
      //4
      { name: "MC1", assigned: false, y:37, x:27 },
      { name: "MC2", assigned: false, y:37, x:63 },

      //2
      {name: "EI", assigned: false, y:10, x:18 },
      { name: "DEL1", assigned: false, y:3, x:36 },
      { name: "DEL2", assigned: false, y:3, x:54 },
      { name: "ED", assigned: false, y:10, x:72 },
    ],
  }
]
